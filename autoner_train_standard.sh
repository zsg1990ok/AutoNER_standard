...
DICT_CORE="data/STANDARD/dict_core.txt"
DICT_FULL="data/STANDARD/dict_full.txt"
EMBEDDING_TXT_FILE="embedding/embedding.txt"
MUST_RE_RUN=0
...
python train_partial_ner.py \
    ...
    --sample_ratio 1.0 --word_dim 300 --epoch 50
