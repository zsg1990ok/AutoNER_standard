if __name__ == '__main__':
	dic1_path = "../dictionaries/transformer_dictionary_segmented.txt"
	dic2_path = "../dictionaries/mechanic_dictionary_segmented.txt"
	diccore_path= "../dictionaries/dic_core.txt"
	dic1 = set()
	dic2 = set()
